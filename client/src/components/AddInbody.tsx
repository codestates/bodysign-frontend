	...
	return (
		<>
			<div
				...
				className="modal-overlay absolute w-full h-full top-0 left-0 bg-black opacity-70 z-10 font-IBM font-thin"></div>
			<div className="modal-container absolute bg-white w-8/12 mx-auto right-0 left-0 rounded shadow-lg z-30 p-3">
				...
				<div className="text-center items-center mb-2">
					<input
						onChange={addDate}
						className="text-xs rounded-xl border p-1 px-3 m-1 w-4/5"
						type="text"
						placeholder="날짜"
					/>
					<input
