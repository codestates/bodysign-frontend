...
const BottomBar = ({ variant = 'Trainer' }: BottomBarProps) => {
	...
	return variant === 'Trainer' ? (
		<div className="text-[1.4rem] flex justify-between py-[0.8rem] px-[4rem] text-[#9F9F9F] border-t bg-gray-50 bottom-0 sticky">
			<Link href="/trainer">
				<span
		...
		<div className="text-[1.4rem] sticky bottom-0 flex justify-between px-8 py-2 text-gray-400 border-t bg-gray-50">
			<Link href="/user">
				<span
					className={`flex flex-col items-center cursor-pointer ${
