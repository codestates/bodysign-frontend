					...
					{!session && (
						<>
							<div className="max-w-screen-md">
								<input
									className="w-4/5 p-1 m-1 border rounded-xl"
									type="text"
									placeholder="이메일"
									onChange={onChangeId}
								/>
								...
								<button
									onClick={onSubmit}
									className="w-4/5 py-1 m-1 text-gray-800 bg-gray-300 rounded hover:bg-gray-400 hover:text-white ">
									로그인
								</button>
								...
								<button
									onClick={onSignup}
									className="w-4/5 py-1 m-1 text-gray-500 transition-colors duration-150 border border-gray-300 rounded focus:shadow-outline hover:bg-gray-300 hover:text-white">
									회원가입
								</button>
							</div>
						</>
