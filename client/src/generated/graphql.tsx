...
export type MutationFindOneUserByPhoneNumberArgs = {
	phoneNumber: Scalars['String']
}
...
export type FindOneUserByPhoneNumberMutationVariables = Exact<{
	phoneNumber: Scalars['String']
}>

export type FindOneUserByPhoneNumberMutation = {
	__typename?: 'Mutation'
...
`
export type FindOneUserByPhoneNumberMutationFn = Apollo.MutationFunction<
	FindOneUserByPhoneNumberMutation,
	FindOneUserByPhoneNumberMutationVariables
>

/**
 * __useFindOneUserByPhoneNumberMutation__
 *
 * To run a mutation, you first call `useFindOneUserByPhoneNumberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useFindOneUserByPhoneNumberMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [findOneUserByPhoneNumberMutation, { data, loading, error }] = useFindOneUserByPhoneNumberMutation({
 *   variables: {
 *      phoneNumber: // value for 'phoneNumber'
 *   },
 * });
 */
export function useFindOneUserByPhoneNumberMutation(
	baseOptions?: Apollo.MutationHookOptions<
		FindOneUserByPhoneNumberMutation,
		FindOneUserByPhoneNumberMutationVariables
	>
...
export type FindOneUserByPhoneNumberMutationHookResult = ReturnType<
	typeof useFindOneUserByPhoneNumberMutation
>
export type FindOneUserByPhoneNumberMutationResult =
	Apollo.MutationResult<FindOneUserByPhoneNumberMutation>
export type FindOneUserByPhoneNumberMutationOptions =
	Apollo.BaseMutationOptions<
		FindOneUserByPhoneNumberMutation,
		FindOneUserByPhoneNumberMutationVariables
	>
