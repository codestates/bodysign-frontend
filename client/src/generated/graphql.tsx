...
export type FindOneUserByPhoneNumberMutation = { __typename?: 'Mutation', findOneUserByPhoneNumber: { __typename?: 'User', id: number, email: string, userName: string, birthDate: any, phoneNumber: string, gender: string, graduate: boolean } };
...
export type SessionQuery = { __typename?: 'Query', session: { __typename?: 'Session', id?: number | null | undefined, userId: number, trainerId: number, feedback?: string | null | undefined, sentFeedback: boolean, date: any, sessionExercises?: Array<{ __typename?: 'SessionExercise', id: number, name: string, sessionExerciseVolumes?: Array<{ __typename?: 'SessionExerciseVolume', id: number, reps: number, sets: number, weight: number, seq: number } | null | undefined> | null | undefined } | null | undefined> | null | undefined } };
...
export const FindOneUserByPhoneNumberDocument = gql`
  ...
  findOneUserByPhoneNumber(phoneNumber: $phoneNumber) {
    ...
    `;
export type FindOneUserByPhoneNumberMutationFn = Apollo.MutationFunction<FindOneUserByPhoneNumberMutation, FindOneUserByPhoneNumberMutationVariables>;
 ...
 * });
 */
export function useFindOneUserByPhoneNumberMutation(baseOptions?: Apollo.MutationHookOptions<FindOneUserByPhoneNumberMutation, FindOneUserByPhoneNumberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<FindOneUserByPhoneNumberMutation, FindOneUserByPhoneNumberMutationVariables>(FindOneUserByPhoneNumberDocument, options);
      }
export type FindOneUserByPhoneNumberMutationHookResult = ReturnType<typeof useFindOneUserByPhoneNumberMutation>;
export type FindOneUserByPhoneNumberMutationResult = Apollo.MutationResult<FindOneUserByPhoneNumberMutation>;
export type FindOneUserByPhoneNumberMutationOptions = Apollo.BaseMutationOptions<FindOneUserByPhoneNumberMutation, FindOneUserByPhoneNumberMutationVariables>;
