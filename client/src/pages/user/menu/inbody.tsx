...
const Inbody: NextPage = () => {
	...
	return (
		<Layout variant="Web">
			<div className="m-5">
				<div className="flex mb-10 content-center mx-4 my-5 text-[12px]">
					<svg
						onClick={moveBack}
						className="m-2"
						viewBox="0 0 15 15"
					...
					<div className="font-bold text-[20px]">인바디</div>
				</div>
				<div className="flex-col inbody-data">
					<div className="mb-3 border">인바디 차트 그림 삽입 예정</div>

					<table className="text-xs text-center border">
						<thead>
							<tr>
								<th>날짜</th>
								<th>체중</th>
