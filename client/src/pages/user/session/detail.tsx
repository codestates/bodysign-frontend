...
const detail: NextPage = ({ date , day, isOpen, changeOpen }) => {
    ...
    const [ feedback, setFeedback ] = useState("수업 피드백이 작성되지 않았습니다.")
        ...
        <Layout variant="Web">
            <div className="flex flex-col m-5 mx-4 my-5 text-[12px]">
                ...
                {exerciseData.map((exercise) => {
                    return (
                    <>
                    <div className="flex border border-gray-300 rounded-2xl mb-2 hover:bg-gray-100 hover:cursor-pointer" onClick={openExerciseDetail}>
                        <div className="inline-block p-1 mx-5 font-bold">{exercise.exerciseName}</div>
                        <div className="flex items-center">
                            {
                                isDetailOpen ? 
                                    <>
                                        ...
                                        <svg className="m-1" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" width="15" height="15"><path d="M4.5 6.5l3 3 3-3" stroke="currentColor" stroke-linecap="square"></path></svg>
                                    </>
                                    :   
                                    <>
                                        <svg className="float-right" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" width="15" height="15"><path d="M8.5 4.5l-3 3 3 3" stroke="currentColor" stroke-linecap="square"></path></svg>
                                    </>
                            }
                        </div>
                    </div>
